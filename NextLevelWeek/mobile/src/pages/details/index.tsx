    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <Text style={styles.pointName}>{toTitleCase(data.point.name)}</Text>
                <Text style={styles.pointItems}>{data.point.items.map(item => item.title).join(', ')}</Text>

                <View style={styles.address}>
                    <Text style={styles.addressTitle}>Endereço</Text>
                    <Text style={styles.addressContent}>{toTitleCase(data.point.city)}, {data.point.uf}</Text>
                </View>
            </View>
